...
export function LiquidText({
    ...
    useEffect(() => {
        ...
        try {
            ...
            fallback.className = "flex h-full w-full items-center justify-center text-4xl font-bold text-neutral-950 dark:text-cyan-400 md:text-6xl";
        ...
        const onPointerMove = (e: PointerEvent) => {
            ...
            pointer.x = ((e.clientX - bounds.left) / (bounds.width || 1)) * 2 - 1;
            pointer.y = -((e.clientY - bounds.top) / (bounds.height || 1)) * 2 + 1;
    ...
    return <div ref={containerRef} className={cn("relative w-full h-[220px] md:h-[300px]", className)} />;
}
