...
interface FlipFadeTextProps {
     ...
     * @default ["SCANNING", "COMPUTING", "DISSECTING", "DETECTING", "NEUTRALIZING"]
     */
    words?: string[];
    /**
...
const defaultWords = ["SCANNING", "HEURISTICS", "AI-INTEL", "URL-CHECK", "SANDBOX", "ZERO-DAY"];
...
const Word = memo(function Word({
    ...
    return (
        <motion.div
            className={cn(
                "flex gap-[0.1em] text-3xl md:text-5xl font-extrabold uppercase tracking-wider text-neutral-900 dark:text-neutral-100",
                textClassName
            )}
            initial="initial"
            animate="animate"
